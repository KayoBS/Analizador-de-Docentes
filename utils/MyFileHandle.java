...
public class MyFileHandle
{
  ...
  public static boolean write(String path, String texto, boolean replace)
  {
    try
    {
      ...
      fw.close();
      bw.close();
      System.out.println(Colors.ANSI_GREEN + "WRITING PROCESS WAS SUCCESSFUL");

      return true;
    }
    catch (IOException e)
    {
      System.out.println(Colors.ANSI_RED + "! WRITING PROCESS FAILURE !");
      System.out.println(Colors.ANSI_RED + "! ERROR: " + e.getMessage() + " !");
    }
    return false;
  }
